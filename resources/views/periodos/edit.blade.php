        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/periodos/'.$data->id.'/edit')}}" autocomplete="off">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">                                    
                                        ...
                                        @php
                                            ...
                                            $f_inicio = date("m/d/Y", strtotime($f_inicio));

                                            $f_fin = $data->f_fin;
                                            $f_fin = date("m/d/Y", strtotime($f_fin));
                                        ...
                                        <div class="form-group form-show-validation row" id="data_1">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control" id="f_inicio" name="f_inicio" value="{{ old('f_inicio', $f_inicio) }}" readonly="readonly">
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-show-validation row" id="data_1">
                                            ...
                                            <div class="input-group date">
                                                <span class="input-group-addon"></span>
                                                <input type="text" class="form-control" id="f_fin" name="f_fin" value="{{ old('f_fin', $f_fin) }}" readonly="readonly">
                                            </div>
                                            </div>
                                        </div>                                                        
