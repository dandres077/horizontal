            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('opciones/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    <td>{{$opciones->id}}</td>
                    <td>{{$opciones->nomtipo}}</td>
                    <td>{{$opciones->nombre}}</td>
                    <td>                             
                    @if ($opciones->status==1)
                        <form method="post" action="{{ url('opciones/'.$opciones->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('opciones/'.$opciones->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                        <a href="{{ url('opciones/'.$opciones->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
