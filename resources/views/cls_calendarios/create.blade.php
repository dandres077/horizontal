                                    ...
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group form-show-validation row" id="data_1">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control" id="fecha" name="fecha" value="{{ old('fecha') }}" readonly="readonly">
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="mss_ano" name="mss_ano" value="{{ old('mss_ano') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="mss_mes" name="mss_mes" value="{{ old('mss_mes') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="cld_esfuerzo_dia" name="cld_esfuerzo_dia" value="{{ old('cld_esfuerzo_dia') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="cld_habil" name="cld_habil" value="{{ old('cld_habil') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="cld_nombre_dia" name="cld_nombre_dia" value="{{ old('cld_nombre_dia') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="cld_semana" name="cld_semana" value="{{ old('cld_semana') }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="cld_sem_mes" name="cld_sem_mes" value="{{ old('cld_sem_mes') }}" required="">
                                            </div>
                                        </div>
