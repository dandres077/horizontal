            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('generos/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    <td>                             
                    @if ($sexos->status==1)
                        <form method="post" action="{{ url('generos/'.$sexos->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('generos/'.$sexos->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                        <a href="{{ url('generos/'.$sexos->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
