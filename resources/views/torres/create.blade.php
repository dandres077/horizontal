    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                <a href="{{ url ('torres')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ url ('torres')}}" class="kt-subheader__breadcrumbs-link">
                Torres </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/torres/store')}}" autocomplete="off">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="kt-form__actions">
                                            ...
                                            <a href="{{ url ('torres')}}" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
