            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Nuevo mensaje</h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/mensajes/store')}}" autocomplete="off" onsubmit="return validar(this)">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        <div class="form-group row">
                                            <div class="col-12">
                                            <input type="text" class="form-control" id="asunto" name="asunto" value="{{ old('asunto') }}" required="" placeholder="Asunto">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-12">
                                            <input type="text" class="form-control" id="destinatario_id" name="destinatario_id" value="{{ old('destinatario_id') }}" required="" placeholder="Para">
                                            </div>
                                        </div>
                                        ...
                                        <div class="kt-form__actions">
                                            ...
                                            <a href="{{ url ('mensajes')}}" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
