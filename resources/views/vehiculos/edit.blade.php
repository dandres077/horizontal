        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/vehiculos/'.$data->bp_id.'/edit')}}" autocomplete="off" enctype="multipart/form-data">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" value="{{ $data->nomapto }}" disabled="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($espacios as $espacio)
                                                    <option value="{{$espacio->id}}" @if($data->parqueadero_id==$espacio->id) selected @endif> {{ $espacio->nombre, $data->parqueadero_id }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="modelo" name="modelo" value="{{ old('modelo', $data->modelo) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($marcas as $marca)
                                                    <option value="{{$marca->id}}" @if($data->marca_id==$marca->id) selected @endif> {{ $marca->marca, $data->marca_id }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($colores as $colores)
                                                    <option value="{{$colores->id}}" @if($data->color_id==$colores->id) selected @endif> {{ $colores->nombre, $data->color_id }}</option>
                                                @endforeach                                               
                                                </select>
                                            </div>
                                        </div>
...
<script type="text/javascript">
  $('#tipo_id').on('change', function(e){
    ...
    $.get('http://157.253.198.43/conjuntos6/public/api/conjunto/{!!$conjunto!!}/parqueaderos/' + province_id,function(data) {
      console.log(data);
...
<script type="text/javascript">
  $('#tipo_id').on('change', function(e){
    ...
    $.get('http://157.253.198.43/conjuntos6/public/api/marcas/'+ province_id,function(data) {
      console.log(data);
