    ...
    <div class="kt-portlet__head-toolbar">
        <div class="kt-portlet__head-wrapper">
            <div class="kt-portlet__head-actions">
                ...
                &nbsp;
                <a href="{{ url ('departamentos/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
<div class="kt-portlet__body">
    ...
    <table class="table table-striped- table-bordered table-hover table-checkable">
        ...
        <tr class="gradeX">
            ...
            <td>{{$departamentos->siglas}}</td>
            <td>                             
                @if ($departamentos->status==1)
                    <form method="post" action="{{ url('departamentos/'.$departamentos->id.'/inactive')}}">
                        {{ csrf_field() }}
                ...
                @else
                    <form method="post" action="{{ url('departamentos/'.$departamentos->id.'/active')}}">
                        {{ csrf_field() }}
            ...
            <td><a href="{{ url('departamentos/'.$departamentos->id.'/edit')}}" type="button" rel="tooltip" title="Editar" class="btn btn-info btn-simple"> <i class="fa fa-edit"></i></a></td>
        </tr>
