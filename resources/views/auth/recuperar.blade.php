						...
						<div class="kt-login__container">
							...
							<div class="kt-login__signup">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Recuperar contraseña</h3>
									<div class="kt-login__desc">Ingresa el email de tu cuenta:</div>
								</div>
								@if ($errors->any())
								...
								@endif
								<form class="kt-form" action="{{ url('/usuario/recuperar')}}" autocomplete="off" method="post">
								{{ csrf_field()}}
									<div class="input-group">
										<input class="form-control" type="email" placeholder="Email" name="email" id="email" value="{{ old('email') }}" autocomplete="off" required>
									</div>									
									<div class="kt-login__actions">
										<button type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Recuperar</button>&nbsp;&nbsp;
