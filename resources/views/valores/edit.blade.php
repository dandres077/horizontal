    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <form method="post" class="form-horizontal" action="{{ url('/valores/'.$data[0]->id.'/edit')}}">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" name="conjunto_id" id="conjunto_id">
                                                    @foreach ($conjuntos as $conjunto)
                                                        <option value="{{$conjunto->id}}" @if($data[0]->conjunto_id==$conjunto->id) selected @endif> {{ $conjunto->nombre, $data[0]->conjunto_id }}</option>
                                                    @endforeach 
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" name="periodo_id" id="periodo_id">
                                                    @foreach ($periodos as $periodo)
                                                        <option value="{{$periodo->id}}" @if($data[0]->periodo_id==$periodo->id) selected @endif> {{ $periodo->nombre, $data[0]->periodo_id }}</option>
                                                    @endforeach 
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" name="opcion_id" id="opcion_id">
                                                    @foreach ($opciones as $opcion)
                                                        <option value="{{$opcion->id}}" @if($data[0]->opcion_id==$opcion->id) selected @endif> {{ $opcion->nombre, $data[0]->opcion_id }}</option>
                                                    @endforeach 
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="valor" name="valor" value="{{ old('valor', $data[0]->valor) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="descripcion" name="descripcion" value="{{ old('descripcion', $data[0]->descripcion) }}" required="">
                                            </div>
                                        </div>
