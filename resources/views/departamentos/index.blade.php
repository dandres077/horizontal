            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    <td>{{$departamento->nompais}}</td>
                    <td>{{$departamento->nombre}}</td>
                    <td>{{$departamento->siglas}}</td>
                    <td>                             
                    @if ($departamento->status==1)
                        <form method="post" action="{{ url('departamentos/'.$departamento->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('departamentos/'.$departamento->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                        <a href="{{ url('departamentos/'.$departamento->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
