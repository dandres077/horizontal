            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('tipos/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    <td>                             
                    @if ($tipos->status==1)
                        <form method="post" action="{{ url('tipos/'.$tipos->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('tipos/'.$tipos->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                        <a href="{{ url('tipos/'.$tipos->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
