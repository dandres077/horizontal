        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/conjuntos/'.$data->id.'/edit')}}" autocomplete="off" enctype="multipart/form-data">
                    {{ csrf_field()}}
                        <div class="row">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="nit" name="nit" value="{{ old('nit', $data->nit) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($paises as $pais)
                                                    <option value="{{$pais->id}}" @if($data->pais_id==$pais->id) selected @endif> {{ $pais->nombre, $data->pais_id }}</option>
                                                @endforeach                                                
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($dptos as $dpto)
                                                    <option value="{{$dpto->id}}" @if($data->dpto_id==$dpto->id) selected @endif> {{ $dpto->nombre, $data->dpto_id }}</option>
                                                @endforeach 
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="localidad" name="localidad" value="{{ old('localidad', $data->localidad) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="barrio" name="barrio" value="{{ old('barrio', $data->barrio) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="estratos_id" name="estratos_id" value="{{ old('estratos_id', $data->estratos_id) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <textarea class="form-control" id="descripcion" name="descripcion" rows="8">{{ old('descripcion', $data->descripcion) }}</textarea>
                                            </div>
                                            </div>
                                        </div>
