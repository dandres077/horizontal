        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tbody>
                @foreach ($data as $residentes)
                <tr class="gradeX">
                    <td>{{$residentes->id}}</td>
                    <td>{{$residentes->nomtorre}}</td>
                    <td>{{$residentes->nombien}}</td>
                    <td>{{$residentes->name}}</td>
                    <td>{{$residentes->last}}</td>
                    <td>{{$residentes->nomidentificacion}}</td>
                    <td>{{$residentes->n_identificacion}}</td>
                    <td>{{$residentes->nomtiporesidente}}</td>
                </tr>
                @endforeach 
                </tbody>
                <tfoot>
