            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('usuarios/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    @can('usuarios.active')        
                    @if ($users->status==1)
                        <form method="post" action="{{ url('usuarios/'.$users->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('usuarios/'.$users->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                    @can('usuarios.edit')
                        <a href="{{ url('usuarios/'.$users->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
