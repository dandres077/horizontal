        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/marcas/'.$marca->id.'/edit')}}">
                    {{ csrf_field()}}
                        <div class="row">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control" name="tipo" id="tipo">
                                                @if ($marca->tipo == 1)
                                                <option value="1" selected="selected">Motocicleta</option>
                                                <option value="2">Vehiculo</option>
                                                @else
                                                <option value="1">Motocicleta</option>
                                                <option value="2" selected="selected">Vehiculo</option>
                                                @endif
                                            </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="marca" name="marca" value="{{ old('marca', $marca->marca) }}">
                                            </div>
                                        </div>
