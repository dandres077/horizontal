        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    <td>{{$preguntas->id}}</td>
                    <td>{{$preguntas->nomconjunto}}</td>
                    <td>{{$preguntas->titulo}}</td>
                    <td>                             
                    @if ($preguntas->status==1)
                        <form method="post" action="{{ url('faq/'.$preguntas->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('faq/'.$preguntas->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                        <a href="{{ url('faq/'.$preguntas->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Editar">
                          <i class="la la-edit"></i>
                        </a>
                    </td>
                    <td>
                        <form method="post" action="{{ url('faq/'.$preguntas->id.'/delete')}}">
                            {{ csrf_field() }}
