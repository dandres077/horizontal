        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('/comercios/'.$data->id.'/edit')}}" autocomplete="off" enctype="multipart/form-data">
                    {{ csrf_field()}}
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="ubicacion" name="ubicacion" value="{{ old('ubicacion', $data->ubicacion) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="horario" name="horario" value="{{ old('horario', $data->horario) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="tags" name="tags" value="{{ old('tags', $data->tags) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-show-validation row" id="data_1">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control" id="fecha_inicio" name="fecha_inicio" value="{{ old('fecha_inicio', $fecha_inicio) }}" readonly="readonly">
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-show-validation row" id="data_1">
                                            ...
                                            <div class="input-group date">
                                                <span class="input-group-addon"></span>
                                                <input type="text" class="form-control" id="fecha_fin" name="fecha_fin" value="{{ old('fecha_fin', $fecha_fin) }}" readonly="readonly">
                                            </div>
                                            </div>
                                        </div>
                                ...
                                @if($validador == 1) <!-- Si tiene registro en la tabla de pibote se visualiza esta sección-->
                                    @foreach ($conjuntos as $conjunto)
                                        @foreach ($comercios_conjuntos as $comercio_conjunto)   
                                            @if($conjunto->id == $comercio_conjunto->conjunto_id)
